...
{
    /// <summary>
    /// A <see langword="class"/> that inspects a closure and loads fields with individual dynamic methods with hierarchy unwrapping
    /// </summary>
    public sealed class ClosureLoaderWithUnwrappedILGetters
    {
        /// <summary>
        /// The list of <see cref="ClosureFieldWithUnwrappedGetter"/> instances mapping the captured variables in the current closure class
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="ClosureLoaderWithUnwrappedILGetters"/> instance after inspecting the given <see cref="Delegate"/>
        /// </summary>
        /// <param name="instance">The input <see cref="Delegate"/> instance to inspect</param>
        /// <returns>A <see cref="ClosureLoaderWithUnwrappedILGetters"/> instance that can be used to load data from instances of the same closure class as the input</returns>
        ...
        public unsafe ClosureData GetData(Delegate instance)
        {
            ...
            {
                ClosureFieldWithUnwrappedGetter field = Fields[i];

                // Load the current field
                object value = field.Getter(instance.Target);
